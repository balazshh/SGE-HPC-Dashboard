...
- `scripts/collect-live.sh` reads `qstat`
- `scripts/collect-history.sh` reads `qacct`
- `scripts/aggregate-rollups.sh` builds hourly/daily rollups from history
- `scripts/cleanup-old-data.sh` enforces retention
